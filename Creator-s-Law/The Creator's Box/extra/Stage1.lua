...
local function startGame()
	...
	function Backgroundss()
		...
		local sunBackground = display.newImageRect(backGroup, "sunBackground.png", display.actualContentWidth, display.contentHeight)
		sunBackground.x = display.contentCenterX
		sunBackground.y = display.contentCenterY
	
		local farMountains = display.newImageRect(backGroup, "mountainsFarBackground.png", display.contentWidth + display.contentWidth/2, display.contentHeight)
		farMountains.anchorX, farMountains.anchorY = 0, 1
		farMountains.x = screenLeft 
		farMountains.y = screenBottom
		farMountains.speed = 0.5
		
		local farMountains1 = display.newImageRect(backGroup, "mountainsFarBackground.png", display.contentWidth + display.contentWidth/2, display.contentHeight)
		...
		local cloudsBackground = display.newImageRect(backGroup, "clouds.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)	
		...
		local cloudsBackground1 = display.newImageRect(backGroup, "clouds.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)	
		...
		local mountains = display.newImageRect(backGroup, "mountainsBackground.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local mountains1 = display.newImageRect(backGroup, "mountainsBackground.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local cloudsNear = display.newImageRect(backGroup, "clouds.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local cloudsNear1 = display.newImageRect(backGroup, "clouds.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local ranges = display.newImageRect(backGroup, "rockyRanges.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		ranges.x = screenLeft
		...
		local ranges1 = display.newImageRect(backGroup, "rockyRanges.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local hills = display.newImageRect(backGroup, "hills.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		hills.x = screenLeft
		...
		local hills1 = display.newImageRect(backGroup, "hills.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local rockyHills = display.newImageRect(backGroup, "rockyHills.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local rockyHills1 = display.newImageRect(backGroup, "rockyHills.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local grassyPlane = display.newImageRect(backGroup, "plane.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
		...
		local grassyPlane1 = display.newImageRect(backGroup, "plane.png", display.actualContentWidth + display.contentWidth/2, display.actualContentHeight)
	...
	local function UIs ()
		...
		local pandorasBoxFill = display.newImageRect (uiGroup, "Creator's Box.png", display.contentCenterX/1.1, display.contentCenterY/2.1)
		...
		pause = display.newImageRect (uiGroup, "pause.png", boxX, boxY)
		...
		local abilityHolder = display.newImageRect(uiGroup, "abilityHolder.png", boxX , boxY)
		...
		local abilityHolder1 = display.newImageRect(uiGroup, "abilityHolder.png", boxX , boxY)
	...
	local function createHero()
        ...
        local heroSheet = graphics.newImageSheet( "heroSprite.png",sheetData )
	...
	local function createEnemy()
        ...
        local enemySheet = graphics.newImageSheet( "Eyeboss1.png",sheetData )
	...
	local function Fight()
		...
		gravity = display.newImageRect (mainGroup, "gravity.png", boxX, boxY)
		spikyDiscTime = display.newImageRect (mainGroup, "spikyDiscTime.png", boxX, boxY)
		rocketTime = display.newImageRect (mainGroup, "rocketTime.png", boxX, boxY)
	...
	timer.performWithDelay(4000, Fight, 1)
		...
		local function startingControl()
			...
			function control(event)
				...
				if ( event.phase == "began" ) then	
					...
					originOfController = display.newImageRect("controller.png", boxX*1, boxY*1)
					originOfController.x = event.x
					originOfController.y = event.y

					Controller = display.newImageRect("pointOfOrigin.png", boxX*2, boxY*2)
					Controller.x = screenLeft - 100
				...
				elseif ( event.phase == "moved" ) then
					...
					if(Controller.x >= originOfController.x - 10) then
						hero.x = hero.x + 3
					end
					...
					if(Controller.y >= originOfController.y + 10) then
						hero.y = hero.y + 3
					end
	...
	timer.performWithDelay(3000, heroControl, 1)
	...
	function pauseMenu()
		local pauseMenu = display.newImageRect(mainGroup, "pauseMenu.png", display.contentWidth/1.5, display.contentHeight*0.65)
		pauseMenu.x = centerX 
		pauseMenu.y = centerY 
		
		local resumeGame = display.newImageRect(mainGroup, "chatBox.png", display.contentWidth/2.5, display.contentHeight*0.15)
		...
		local pauseGame = display.newImageRect(mainGroup, "chatBox.png", display.contentWidth/2.5, display.contentHeight*0.15)
		pauseGame.x = centerX
		pauseGame.y = centerY 		
		...
		local quitGame = display.newImageRect(mainGroup, "chatBox.png", display.contentWidth/2.5, display.contentHeight*0.15)
		quitGame.x = centerX
		...
		local function quitGamer()
			...
			local noQuit = display.newImageRect(mainGroup, "chatBox.png", display.contentWidth/4.5, display.contentHeight*0.15)
			noQuit.x = centerX + centerX/3
			noQuit.y = centerY 
			
			local yesQuit = display.newImageRect(mainGroup, "chatBox.png", display.contentWidth/4.5, display.contentHeight*0.15)
...
local function introduction()
	...
	physics.pause ()
	local introEyeWizardBox = display.newImageRect ( mainGroup, "pauseMenu.png", display.contentWidth/1.5, display.contentHeight/1.4)
	introEyeWizardBox.x = display.contentCenterX/1.75
	introEyeWizardBox.y = display.contentCenterY
	introEyeWizardBox.alpha = 0.75

	closeEyeWizard = display.newImageRect (mainGroup, "close.png", display.contentWidth/11, display.contentHeight/7)
	...
	local function eyeBossSprite()
        ...
        local mySheet = graphics.newImageSheet( "Eyeboss1.png",sheetData )
...
function scene:create( event )
	...
	local background = display.newImageRect( backGroup, "stage1whole.png", display.actualContentWidth,display.actualContentHeight )
